<?php
    ...
    $default = 12;
    $default_check = "SELECT userID FROM user_role WHERE userID = '$default' AND roleName = '$roleName'";
    $result_default_check  = mysqli_query($conn, $default_check);

    if(mysqli_num_rows($result_default_check) > 0)
    {
        //update
